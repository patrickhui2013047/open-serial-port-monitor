...
{
    public class SerialCommandViewModel : PropertyChangedBase, IHandle<SerialPortConnect>, IHandle<SerialPortDisconnect>, IHandle<ConnectionError>
    {
        ...
        public SerialCommandViewModel(IEventAggregator eventAggregator)
        {
